...
const articles: Article[] = [
  {
    ...
    color: "orange",
    summary:
      "Relive the inauguration of our state-of-the-art Experience Centre — a milestone moment for Gulf-O-Flex® and a new destination for engineers, consultants and partners.",
    featured: true,
    readTime: 3,
    author: "GOF Newsroom",
    tags: ["Experience Centre", "Inauguration", "UAE"],
    trending: true,
    video: "https://www.youtube.com/watch?v=_xBbdDqPclk",
  },
  {
    title: "Gulf-O-Flex® Corporate Overview",
    date: "2024",
    iso: "2024-06-01",
    category: "Events",
    color: "blue",
    summary:
      "A comprehensive look at Gulf-O-Flex® — our manufacturing capabilities, product range, global reach, and commitment to quality insulation solutions.",
    readTime: 4,
    author: "Marketing",
    tags: ["Corporate", "Overview", "Manufacturing"],
    video: "https://www.youtube.com/watch?v=_O2ZHFaFFyM",
  },
  {
    title: "Gulf-O-Flex® Product Range Showcase",
    date: "2024",
    iso: "2024-05-01",
    category: "Product Launch",
    color: "green",
    summary:
      "Explore the complete Gulf-O-Flex® product ecosystem — NBR, XLPE, Sound, Ultra, Aluglass, Aluclad and UltraLine insulation solutions for every application.",
    readTime: 3,
    author: "Marketing",
    tags: ["Products", "Showcase", "Insulation"],
    video: "https://www.youtube.com/watch?v=qGekb0VosA4",
  },
  {
    title: "Gulf-O-Flex® Manufacturing Excellence",
    date: "2024",
    iso: "2024-04-01",
    category: "Operations",
    color: "cyan",
    summary:
      "Step inside our world-class manufacturing facility in the UAE — see how Gulf-O-Flex® insulation is engineered, produced, and quality-controlled to international standards.",
    readTime: 3,
    author: "Operations",
    tags: ["Factory", "Manufacturing", "Quality"],
    video: "https://www.youtube.com/watch?v=juoWIase370",
  },
  {
    title: "Gulf-O-Flex® Technical Applications",
    date: "2024",
    iso: "2024-03-01",
    category: "Technical",
    color: "purple",
    summary:
      "See Gulf-O-Flex® insulation in action across HVAC, oil & gas, marine, and industrial applications — real-world installations demonstrating performance and durability.",
    readTime: 3,
    author: "Technical Team",
    tags: ["Applications", "HVAC", "Installation"],
    video: "https://www.youtube.com/watch?v=qAH6pfbrANY",
  },
  {
    title: "Gulf-O-Flex® Quality & Testing",
    date: "2024",
    iso: "2024-02-01",
    category: "Technical",
    color: "amber",
    summary:
      "Our rigorous quality assurance process — from raw material testing to finished product certification. See why Gulf-O-Flex® meets the most demanding international standards.",
    readTime: 3,
    author: "Quality Team",
    tags: ["Quality", "Testing", "Certification"],
    video: "https://www.youtube.com/watch?v=m4O2Cl7SpYM",
  },
  {
    title: "Gulf-O-Flex® Global Presence",
    date: "2024",
    iso: "2024-01-01",
    category: "Distribution",
    color: "emerald",
    summary:
      "From the UAE to 90+ countries worldwide — discover Gulf-O-Flex®'s global distribution network and our commitment to serving engineers and contractors everywhere.",
    readTime: 3,
    author: "Commercial Desk",
    tags: ["Global", "Distribution", "Export"],
    video: "https://www.youtube.com/watch?v=LhFXc1ToLbg",
  },
  {
